# Generated by Django 5.1.4 on 2025-01-09 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_start_time', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
                ...
                ('customer', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='authentication.customerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='JobApplication',
            fields=[
                ...
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.workerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Dimona',
