...
<<<<<<< HEAD
        worked_hours = (
            TimeRegistration.objects.filter(
                job__in=jobs, start_time__range=(week_start, week_end)
            )
        ...
        upcoming_hours = (
            jobs.filter(job_state=JobState.pending)
            .annotate(duration=F("end_time") - F("start_time"))
            .aggregate(total_duration=Sum("duration"))["total_duration"]
            or datetime.timedelta()
        )
...
<<<<<<< HEAD
                upcoming_work = (
                    jobs.filter(start_time__date=day, job_state=JobState.pending)
                    .annotate(duration=F("end_time") - F("start_time"))
                    .aggregate(total_duration=Sum("duration"))["total_duration"]
                    or datetime.timedelta()
                )
...
<<<<<<< HEAD
            ...
            next_month = month_start.replace(day=28) + datetime.timedelta(
                days=4
            )  # This will always move to the next month
...
<<<<<<< HEAD
                worked_hours = (
                    TimeRegistration.objects.filter(
                        job__in=jobs, start_time__range=(month_start, month_end)
                    )
                    .annotate(duration=F("end_time") - F("start_time"))
                    .aggregate(total_duration=Sum("duration"))["total_duration"]
                    or datetime.timedelta()
