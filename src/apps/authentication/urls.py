...
<<<<<<< HEAD
    ...
    JWTRefreshView,
    JWTTestConnectionView,
    ProfileMeView,
    LanguageSettingsView,
    UploadUserProfilePictureView,
...
urlpatterns += [
    ...
    path(
        "users/settings/languages",
        LanguageSettingsView.as_view(),
        name="language_settings",
    ),
    path(
        "users/settings/profile-picture",
        UploadUserProfilePictureView.as_view(),
        name="upload_profile_picture",
    ),
    path("password_reset", PasswordResetRequestView.as_view(), name="password_reset"),
    path(
        "password_reset/verify", VerifyCodeView.as_view(), name="password_reset_verify"
    ),
    path(
        "password_reset/reset", ResetPasswordView.as_view(), name="password_reset_reset"
    ),
    path(
        "registration/verify",
        ValidateRegistrationView.as_view(),
    ...
    path(
        "workers/<str:sort_term>/<str:algorithm>/<int:count>/<int:page>",
    ...
    path(
        "<str:state>/workers/<str:sort_term>/<str:algorithm>/<int:count>/<int:page>",
        WorkersListView.as_view(),
    ),
    path("<str:state>/workers/<int:count>/<int:page>", WorkersListView.as_view()),
    path(
        "<str:state>/workers/<int:count>/<int:page>/<str:search_term>",
        WorkersListView.as_view(),
    ),
    path(
        "admin/workers/profile/<str:user_id>",
    ...
    path(
        "customers/<str:sort_term>/<str:algorithm>/<int:count>/<int:page>",
        CustomersListView.as_view(),
    ),
    path("customers/<int:count>/<int:page>", CustomersListView.as_view()),
    path(
        "customers/<int:count>/<int:page>/<str:search_term>",
        CustomersListView.as_view(),
    ),
    path(
        "customers/details/<str:id>",
        CustomerDetailView.as_view(),
        name="customer_detail",
    ),
    path(
        "customers/<str:search_term>",
        CustomerSearchTermView.as_view(),
...
urlpatterns = [
    ...
    path('hello/there', JWTTestConnectionView.as_view(), name='test_connection'),
    path('users/me', ProfileMeView.as_view(), name='profile_me'),
    path('users/profile-completion/', ProfileCompletionView.as_view(), name='profile_completion'),
    path('users/settings/languages', LanguageSettingsView.as_view(), name='language_settings'),
    path('users/settings/profile-picture/<uuid:id>/', UploadUserProfilePictureView.as_view(), name='upload_profile_picture'),
    path('password_reset', PasswordResetRequestView.as_view(), name="password_reset"),
