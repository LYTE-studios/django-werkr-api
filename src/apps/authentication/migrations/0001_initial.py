    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customer_address', to='core.address')),
                ('billing_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customer_billing_address', to='core.address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted', models.BooleanField(default=True)),
                ('hours', models.FloatField(default=0, null=True)),
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='worker_address', to='core.address')),
