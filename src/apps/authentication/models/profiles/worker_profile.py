...
class WorkerProfile(models.Model):
    ...
    worker_address = models.ForeignKey(
        Address, null=True, on_delete=models.CASCADE, related_name="worker_address"
    )
    ...
    worker_type = models.CharField(
        max_length=10, choices=WorkerType.choices, default=WorkerType.STUDENT
    )
